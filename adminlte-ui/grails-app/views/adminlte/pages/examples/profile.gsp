                ...
                <div class="post">
                  ...
                  <div class="row margin-bottom">
                    ...
                    <div class="col-sm-6">
                      <div class="row">
                        <div class="col-sm-6">
                          <img class="img-responsive" src="/static/dist/img/photo2.png" alt="Photo">
                          <br>
                          <img class="img-responsive" src="/static/dist/img/photo3.jpg" alt="Photo">
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                          <img class="img-responsive" src="/static/dist/img/photo4.jpg" alt="Photo">
                          <br>
                          <img class="img-responsive" src="/static/dist/img/photo1.png" alt="Photo">
                        </div>
                        <!-- /.col -->
